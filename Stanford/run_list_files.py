...
path = "F:/MIASHS/UEs/text_analysis/now_corpus/corpus4/"
...
for l in laListeOK: # Enlever [0:2] quand ça marche !!!!!
    print(l)
    toRun = 'java -cp "*" -Xmx1g edu.stanford.nlp.pipeline.StanfordCoreNLP -props sampleProps.properties -file '+l+' -outputDirectory output'
    sp.run(toRun)
